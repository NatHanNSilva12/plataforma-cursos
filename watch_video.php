...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'removeido dos curtidos';
      }else{
         ...
         $message[] = 'adicionado aos curtidos!';
      }
   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            $message[] = 'comentario já adicionado!';
         }else{
...
<?php
      ...
      $message[] = 'comentário não adicionado';
   }
}
?>
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>curtido</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>curtir</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">sem videos encontrados</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading">adicionar um comentário</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">deletar comentário</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">nenhum comentário, seja o primeiro a comentar!</p>';
      }
      ?>
      </div>
