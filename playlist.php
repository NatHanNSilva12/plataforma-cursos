...
if(isset($_POST['save_list'])){
   ...
   if($user_id != ''){
      ...
      $message[] = 'por favor, registre-se primeiro!';
   }
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>salvo</span></button>
            <?php
               }else{
            ?>
      ...
      <?php
            ...
            echo '<p class="empty">esta playlist não foi encontrada!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">sem videos!</p>';
         }
      ?>
