...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>antiga senha</p>
               <input type="password" name="old_pass" placeholder="antiga senha<" maxlength="50" class="box">
               <p>nova senha</p>
               <input type="password" name="new_pass" placeholder="nova senha" maxlength="50" class="box">
               <p>confirme a senha</p>
               <input type="password" name="cpass" placeholder="confirme a senha" maxlength="50" class="box">
         </div>
      </div>
