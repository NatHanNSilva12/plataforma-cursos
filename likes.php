...
<section class="liked-videos">
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Assistir a aula</a>
   ...
   <?php
            ...
            echo '<p class="emtpy">conteudo não encontrado!</p>';         
         }
      }
   }else{
      echo '<p class="empty">nada adicionado aos curtidos!</p>';
   }
   ?>
