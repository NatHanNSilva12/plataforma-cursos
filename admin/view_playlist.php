   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete playlist" class="delete-btn" onclick="return confirm('deletar essa playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
...
<section class="contents">
   ...
   <?php
         ...
         echo '<p class="empty">nenhum video adicionado ainda! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">adicionar videos</a></p>';
      }
   ?>
